"""
Authors:  Dave Fisher and John Hayden Cope III.
"""
import time
import rosebot
...
def run_test_drive_system():
    ...
    # -------------------------------------------------------------------------
    # 2. Construct a robot, that is, a rosebot.RoseBot() object.
    # -------------------------------------------------------------------------
    robot = None
...
def run_test_go_stop(robot):
    ...
    robot.drive_system.close() # Close the motors when done.
...
def run_test_go_straight_for_seconds(robot):
    ...
    while True:
        ...
        left_right = input("Enter 'L' for left wheel or 'R' for right wheel: ")
        ...
        # -------------------------------------------------------------------------
        #  4. Call the  go_straight_for_seconds  method of the   drive_system
